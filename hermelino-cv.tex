...
\begin{document}
	...
	\begin{center}
			\faEnvelope \ hermelinosouza@gmail.com \ $\cdot$ \ \faPhone \ (85) 9 9447.2909 \ $\cdot$ \ \faUniversity \ \href{http://lattes.cnpq.br/3460004816166577}{Lattes} \\
			\faHome \ \href{https://hermelino.github.io/}{hermelino.github.io/} \ $\cdot$ \ \faLinkedin \ \href{https://www.linkedin.com/in/hermelinosouza}{hermelinosouza} \ $\cdot$ \ \faGithub \ \href{https://github.com/hermelino}{github.com/hermelino} \\
	\end{center}

	\subsection*{Escolaridade}
	\vspace{0.05cm}
	\begin{flushleft}
	\begin{tabular}[t]{>{\raggedleft\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{13cm}}
		...
		& Orientador: \href{http://lattes.cnpq.br/8821559850261716}{Guilherme Diniz Irffi} \\
		\multicolumn{2}{c}{} \\
		...
		& Orientador: \href{http://lattes.cnpq.br/6095762582986164}{Mauricio Benegas} \\
		\multicolumn{2}{c}{} \\
	...
	\begin{longtable}[t]{>{\raggedleft\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{13cm}}
		\textsc{2022-2023} & \textbf{Departamento de Economia Aplicada} \\
		& Faculdade de Economia, Administração, Atuária e Contabilidade - UFC \\
		& Professor Substituto (20h/sem)  \vspace{0.1cm} \\
		& {\textbf{Disciplinas ministradas}: Economia Matemática I e II, Estatística Econômica II, Econometria I, Introdução à Macroeconomia, Contabilidade Nacional, Economia do Setor Público e Metodologia de Pesquisa } \\
		\multicolumn{2}{c}{} \\
	...
	\begin{flushleft}
		\begin{tabular}[t]{>{\raggedleft\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{13cm}}
			2024 & Benegas, M.; Souza, H. N. \href{https://periodicos.fgv.br/rbe/article/view/73892}{\textit{Nonparametric Estimation of Capacity Utilization Rates in Brazilian Manufacturing Sectors}} \\
	...
	\subsection*{Programação e Idiomas}
	\vspace{0.05cm}
	\begin{flushleft}
		\begin{tabular}[t]{>{\raggedleft\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{13cm}}
			\textbf{Programação} & R, Stata, Python, SQL, \LaTeX{} e Office \\
			\textbf{Idiomas} & \textbf{Inglês} (Avançado), \textbf{Alemão} (Iniciante) \\
		\end{tabular}
	\end{flushleft}
